...
static void _flush(uint32_t index, uint8_t bits) {
	...
	GPIO_TypeDef *_port_map[] = { SEG_A_GPIO_Port, SEG_B_GPIO_Port,
	SEG_C_GPIO_Port, SEG_D_GPIO_Port, SEG_E_GPIO_Port, SEG_F_GPIO_Port,
	SEG_G_GPIO_Port, SEG_H_GPIO_Port };
	uint16_t _pin_map[] = { SEG_A_Pin, SEG_B_Pin, SEG_C_Pin, SEG_D_Pin,
	SEG_E_Pin, SEG_F_Pin, SEG_G_Pin, SEG_H_Pin };
	GPIO_TypeDef *_4_port_map[] = { SEG_S0_GPIO_Port, SEG_S1_GPIO_Port,
	SEG_S2_GPIO_Port, SEG_S3_GPIO_Port };
	uint16_t _4_pin_map[] = { SEG_S0_Pin, SEG_S1_Pin, SEG_S2_Pin,
	SEG_S3_Pin };
	uint8_t s = 1 << index;
	for (int i = 0; i < 4; i++) {
